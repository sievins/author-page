  ...
  return (
    <div className={classes.container}>
      ...
      <p>
        ...
        <Link
          href="https://www.facebook.com/sarahsfootsteps/"
          target="_blank"
          rel="noreferrer"
        >
          www.facebook.com/sarahsfootsteps
        </Link>
      </p>
      <p>
        Or talk to Alice about your favourite fantasy in her readers' group:{" "}
        <Link
          href="https://www.facebook.com/groups/AliceIvinya/"
          target="_blank"
          rel="noreferrer"
        >
          www.facebook.com/groups/AliceIvinya
        </Link>
      </p>
    </div>
  );
